...
echo ""
echo "📝 Next steps:"
echo "   1. Create a GitHub release: https://github.com/dedsecrattle/argus/releases/new"
echo "   2. Build and push Docker image: docker build -t dedsecrattle/argus:latest . && docker push dedsecrattle/argus:latest"
